package com.sillyhat.cloud.groovytest.eg3
...
class MultipleTestSpec extends spock.lang.Specification{
    ...
    def "get max usable cashback price.multiple customer.interval"() {
        given: "initial mock data"
        CustomerService customerService = Stub(CustomerService) {
            getCustomerCashback(1) >> 500
            getCustomerCashback(2) >> 888888
        ...
        expect: "that all filenames are categorized correctly"
        testService.getMaxUsableCashbackPrice(1,totalPrice) == 500
