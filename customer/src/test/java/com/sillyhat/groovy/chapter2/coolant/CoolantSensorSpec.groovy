...
class CoolantSensorSpec extends spock.lang.Specification{
	...
	def "If current temperature difference is within limits everything is ok"() {
		...
		TemperatureReadings prev = new TemperatureReadings(sensor1Data:20,sensor2Data:40,sensor3Data:80)//first return
		TemperatureReadings current = new TemperatureReadings(sensor1Data:30,sensor2Data:45,sensor3Data:73)//second return
