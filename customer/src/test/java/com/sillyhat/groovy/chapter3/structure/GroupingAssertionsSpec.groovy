package com.sillyhat.groovy.chapter3.structure

import com.sillyhat.groovy.chapter3.dto.DefaultCustomerResolver
import com.sillyhat.groovy.chapter3.dto.EnterprisyBasket
import com.sillyhat.groovy.chapter3.dto.Product
import com.sillyhat.groovy.chapter3.dto.WarehouseInventory


class GroupingAssertionsSpec extends spock.lang.Specification{

	def "Buying products reduces the inventory availability (old)"() {
